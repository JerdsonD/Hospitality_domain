Importing and verifying data, a few transformations and cleaning in query, and analysing the data for the following metrics: RevPar , ADR , Revenue  , Platforms.
